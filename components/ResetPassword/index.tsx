      ...
      <div className="flex flex-col items-center bg-[white] mt-[160px]">
        <div className="min-w-[400px]">
          ...
          <form onSubmit={handleForgetPassword} className="px-3 flex flex-col items-center">
            {/* Email Field */}
            <div className="mt-5 flex flex-col w-full relative">
            ...
            <div className="mt-3 w-full">
              <button
                type="submit"
                className="w-full text-[#f0f0f0] font-bold rounded-lg py-2 bg-[#f18021] border border-black-500"
              >
                {loading ? <BeatLoader size={10} color="#f0f0f0" /> : "Submit"}
              </button>
            </div>
          </form>
        </div>
